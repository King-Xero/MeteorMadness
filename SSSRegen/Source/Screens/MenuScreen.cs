        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!menu.Visible) //If the menu isn't visible
            {
                ...
                else
                {
                    ...
                    line3Position =
 new Vector2((line2Position.X + line2Rectangle.Width - line3Rectangle.Width / 2), line2Position.Y);
#else //Calculation for position of line 3 on PC
                    line3Position =
                        new Vector2((line2Position.X + line2Rectangle.Width - line3Rectangle.Width / 2) - 80,
                            line2Position.Y);
#endif
