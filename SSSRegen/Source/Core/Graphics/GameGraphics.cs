...
namespace SSSRegen.Source.Core.Graphics
{
    public class GameGraphics : IGameGraphics
    {
        ...
        public void Draw(ISprite sprite, Rectangle destinationRect, Color color, float rotation, Vector2 origin)
        {
            _spriteBatch.Begin(transformMatrix: _screenSizeManager.GetScreenScaleTransformationMatrix());
            _spriteBatch.Draw(sprite.Texture, destinationRect, sprite.SourceRectangle, color, rotation, origin, SpriteEffects.None, 0f);
            _spriteBatch.End();
        }
        ...
        public void DrawText(IUIText uiText, Vector2 position, Color color, float rotation, Vector2 origin)
        {
            _spriteBatch.Begin(transformMatrix: _screenSizeManager.GetScreenScaleTransformationMatrix());
            _spriteBatch.DrawString(uiText.Font, uiText.Text, position, color, rotation, origin, 1.0f, SpriteEffects.None, 0f);
            _spriteBatch.End();
        }
