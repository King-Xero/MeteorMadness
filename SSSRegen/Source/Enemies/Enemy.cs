...
{
    public class Enemy : Sprite, IDamageableGameObject
    {
        ...
        public Enemy(Game game, Random random, ref Texture2D spriteSheet, List<Rectangle> spriteFrames) : base(game, ref spriteSheet)
        {
        ...
        public void OnCollision(ICollisionGameObject col)
        {
            ...
            {
                //ToDo should do some damage calculation to check if enemy should be "destroyed"
                Reset();
            }
        }
