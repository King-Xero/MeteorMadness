...
namespace SSSRegen
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //Help Screen
            helpBackgroundTexture = Content.Load<Texture2D>(@"HelpImages/HelpBackground"); //Help Screen Background
            helpForegroundTexture = Content.Load<Texture2D>(@"HelpImages/HelpInfo"); //Help Screen Image
            ...
            menuBackgroundTexture = Content.Load<Texture2D>(@"MenuImages/MenuBackground"); //Menu Screen Background
            menuElementsTexture = Content.Load<Texture2D>(@"MenuImages/MenuElements"); //Menu Screen Title
            ...
            playElementsTexture = Content.Load<Texture2D>(@"PlayImages/SpriteSheet"); //Sprite Sheet for the game
            playBackgroundTexture = Content.Load<Texture2D>(@"PlayImages/GameBackGround"); //Play Screen Background
